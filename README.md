...
![Send data gif](videos/1_send_data/send_data.gif)
...
![Send hex gif](videos/2_hexa/hexa.gif)
...
![Send command gif](videos/3_cmds/cmds.gif)
...
![Command history](videos/4_history/history.gif)
...
![Reconnect gif](videos/5_reconnect/reconnect.gif)
...
![Read ANSI color gif](videos/6_ansi/ansi.gif)
...
![Special character gif](videos/7_invisible/invisible.gif)
...
![Setup serial port](videos/8_setup_serial/setup_serial.gif)
...
![Save history](videos/9_save/save.gif)
...
![Save record](videos/10_record/record.gif)
...
![Plugin usage](videos/11_plugin/plugin.gif)
